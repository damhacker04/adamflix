...
<head>
    ...
    <title>@yield('title') - Adamflix</title>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-4 col-md-6 offset-md-6">
                <div class="text-center">
                    <img src="{{ asset('assets/img/adamflix_logo.png') }}" class="adamflix-title" alt="Adamflix Logo">
                    <h3 class="adamflix-sign-in">@yield('page-title')</h3>
                </div>
                @if ($errors->any())
